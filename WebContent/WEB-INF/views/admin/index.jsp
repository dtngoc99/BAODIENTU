					...
					<div class="row">
						...
						<div id="myTabContent" class="tab-content"
							...
							<div class="tab-pane fade active in" id="news"
								...
								<input type="number" value="1" min="1" max="20" id="par_quantity" name="par_quantity" >
								<a><button type="submit"
										class="btn btn-primary" onclick="checkNews()">Thêm bản tin</button></a> <br> <br>
								<table class="table">
									<thead>
										<tr>
...
<script>
	...
	function checkNews(){
		var value = parseInt(document.getElementById("par_quantity").value);
		if(value < 1 || value > 20)
			alert("Số lượng đoạn không hợp lệ !");
		else
			window.location.href = "http://localhost:8080/BAODIENTU/admin/insert-news.htm?par_quantity=" + value;
	}
</script>
</html>